...
```diff
# wrangler.toml
name = "cloudfare-d1-nextauth-prisma"
main = "src/index.ts"
...
```
npx wrangler d1 execute cloudfare-d1-nextauth-prisma --file=prisma/schema.sql --local
```
...
```
npx wrangler d1 execute cloudfare-d1-nextauth-prisma --file=prisma/schema.sql --remote
```
...
```
npx wrangler d1 execute cloudfare-d1-nextauth-prisma --command "INSERT INTO  \"User\" (\"email\", \"name\") VALUES
